...
def convert_hf_whisper_encoder(model_metadata: dict, model_params: dict, quant_algo: str = None,):
    ...
    weights['ln_post.weight'] = model_params['encoder.layer_norm.weight'].contiguous()
    weights['ln_post.bias'] = model_params['encoder.layer_norm.bias'].contiguous()
...
def convert_hf_whisper_decoder(model_metadata: dict, model_params: dict, quant_algo: str = None):
    ...
    weights['final_layernorm.weight'] = model_params['decoder.layer_norm.weight']
    weights['final_layernorm.bias'] = model_params['decoder.layer_norm.bias']
